  ...
  return (
    <>
      ...
      <div className="px-5">
        ...
        <div className="my-10 rounded-2xl bg-pink-100 mx-auto md:max-w-250 flex justify-center">
        ...
        <div class="my-10 rounded-2xl bg-pink-100 mx-auto md:max-w-250 flex justify-center flex items-center">
        ...
        <div class="my-10 rounded-2xl bg-pink-100 mx-auto md:max-w-250 flex justify-center max-width-3xs flex items-center">
          <div className="my-10 mx-5 h-90 md:h-100 w-100">
            <div className="my-5 rounded-full w-20 text-2xl bg-red-300">
              アプリ
            </div>
