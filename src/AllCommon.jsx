    ...
    <div>
      <div className="flex justify-between m-5">
        ...
        <div className="flex my-auto md:justify-end">
          <div className="w-1 invisible md:w-140 md:visible flex">
            <div className="text-xl md:text-2xl me-1 md:mx-2 underline hover:opacity-50">
              <button
                role="link"
                class="relative underline decoration-wavy underline-offset-4 transition-colors duration-300 hover:text-blue-500 hover:underline"
              >
                {" "}
